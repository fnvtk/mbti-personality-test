...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-between h-full px-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm hidden sm:block text-gray-900">超级管理后台</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" onClick={() => router.push("/admin/dashboard")} className="text-gray-600 text-xs">
      ...
      {/* 侧边栏 - 浅色 */}
      <aside className={cn(
        "fixed left-0 top-14 bottom-0 w-52 bg-white border-r border-gray-200 transition-transform z-40 overflow-y-auto",
        "lg:translate-x-0",
